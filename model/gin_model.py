...
class GNN(torch.nn.Module):
    ...
    """
    def __init__(self, num_layer, emb_dim, JK = "concat", drop_ratio = 0, gnn_type = "gin"):
        ...
        ## torch.nn.Embedding:first:一共几个整数选择；second:每个encode成几维的embedding

        # self.x_embedding1 = torch.nn.Embedding(num_atom_type, emb_dim)
        # self.x_embedding2 = torch.nn.Embedding(num_chirality_tag, emb_dim)
        self.x_embedding1 = torch.nn.Embedding(7, emb_dim)
        self.x_embedding2 = torch.nn.Embedding(30, emb_dim)
        self.x_embedding3 = torch.nn.Embedding(10, emb_dim)
